...
import aboutUsStyle from "../../assets/jss/material-kit-pro-react/views/componentsSections/aboutUsStyle";
...
export default function AboutUsPage() {
  ...
  return (
    <div>
      ...
      <Parallax image= "https://cdn.pixabay.com/photo/2017/08/29/01/22/dog-2691871_1280.jpg"  filter="light" small>
        <div className={classes.container}>
          <GridContainer justify="center">
            ...
            >
              <h1 className={classes.title}>PUPPY LOVE!</h1>
