...
import servicesStyle from "../../../assets/jss/material-kit-pro-react/views/componentsSections/contactStyle";
  ...
  return (
    <div className={classes.services}>
      <GridContainer>
        ...
        >
          <h2 className={classes.title}>We build great homes for dogs!</h2>
